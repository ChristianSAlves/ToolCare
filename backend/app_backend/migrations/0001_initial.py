    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigoEmprestimo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='itens', to='app_backend.emprestimo')),
                ('idFerramenta', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='emprestimos', to='app_backend.ferramenta')),
            ],
        ),
        migrations.CreateModel(
